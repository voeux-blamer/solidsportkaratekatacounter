...
if (isset($_POST['simpan'])) {
    ...
    `nilai_technic`= 0,`nilai_athletic` = 0,`dinilai`=0,`id_atlet`="' . $id_atlet . '",`pertandingan_ke`="' . $pertandingan_ke . '",`id_jenis` = "2"';
    mysqli_query($mysqli,'INSERT INTO `tabel_detail` (id,nama_atlet,id_jenis,pertandingan_ke)
    VALUES ("'.$id_atlet.'","'.$nama_atlet.'","2","' . $pertandingan_ke . '")');
    ...
    if ($simpan > 0) {
        ...
        header('location:tampil_data_pertandingan.php?pertandingan_ke=' . $pertandingan_ke . '&btnPilih=Ok');
    } else {
